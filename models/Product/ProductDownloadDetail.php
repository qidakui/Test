...
/**
 * This is the model class for table "{{product_download_detail}}".
 *
 * The followings are the available columns in table '{{product_download_detail}}':
 * @property string $id
...
class ProductDownloadDetail extends \CActiveRecord
{
        public $msg = array(
           'Y' => '成功',
           1001 => '数据异常，请联系管理员'
	...
	{
		return '{{product_download_detail}}';
	}
	 ...
	 * @return ProductDownloadDetail the static model class
	 */
	public static function model($className=__CLASS__)
	{
         ...
         * 导出列表
         */
        function exportdownload($filiale_id,$starttime,$endtime){
		...
		$filiale_name = isset($city[0]['region_name'])?$city[0]['region_name']:'';
            ...
            \FwUtility::exportExcel($data, $header,'产品-下载统计','产品-下载统计_'.$filiale_name.'-'.substr($starttime,0,7));             
        }
}
